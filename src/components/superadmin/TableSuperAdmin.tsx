...
const TableSuperAdmin: React.FC<TableSuperAdminProps> = () => {
 ...
 const handleChangeRowsPerPage = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const [isOpenSuspendUserModal, setIsOpenSuspendUserModal] = useState<boolean>(false);
const handleCloseInviteModal = ()=>{
  ...
  const currentButton =()=>{
    ...
    return (<Button style={{height:'80%',margin:'auto'}} onClick={handleOpenInviteModal} variant="contained" color="primary">
  New company
</Button>)
    }
if (currentTab === GUEST) {
  ...
  return (
     <div className={classes.root}>
              <InviteModal type={currentTab} isOpen={isOpenInviteModal} handleClose={handleCloseInviteModal} handleOpen={handleOpenInviteModal} />
              <UserDetailModal isOpen={isOpenUserDetailModal} handleClose={handleCloseUserDetailModal} handleOpen={handleOpenUserDetailModal} />
      <AskModal  isOpen={isOpenDeleteUserModal} handleClose={toggleDeleteUserModal} handleOpen={toggleDeleteUserModal} okText="Sure" cancelText="Cancel" title="Delete User" subtitle="Are you sure you want to delete this user?"/>
      <AskModal  isOpen={isOpenSuspendUserModal} handleClose={toggleSuspendUserModal} handleOpen={toggleSuspendUserModal} okText="Sure" cancelText="Cancel" title="Suspend User" subtitle="Are you sure you want to suspend this user?"/>
     ...
     {currentTab === COMPANIES && <Table className={classes.table} aria-label="customized table">
        <TableHead>
          <TableRow>
            <StyledTableCell align="center">Name</StyledTableCell>
            <StyledTableCell align="center">Email</StyledTableCell>
            <StyledTableCell align="center">Number of Invitations</StyledTableCell>
        ...
        <TableBody>
          {rows.map((row) => (
            <StyledTableRow key={row.name}>
              ...
              <StyledTableCell align="center">{row.protein}</StyledTableCell>
              <StyledTableCell  align="center">       <Chip color="primary" style={{ width:'100%'}}  label={"inactive"} /> </StyledTableCell>
              <StyledTableCell align="center">{row.protein}</StyledTableCell>
      ...
      {currentTab === GUEST && <Table className={classes.table} aria-label="customized table">
        <TableHead>
          <TableRow>
            <StyledTableCell align="center">Name</StyledTableCell>
            <StyledTableCell align="center">Email</StyledTableCell>
